...
const char *WINDOWTITLE = { "Project5 - Chao Zhang" };
...
Display( )
{
	...
	Pattern->SetUniformVariable("usOn", sOn);
	Pattern->SetUniformVariable("uvSOn", vSOn);
	Pattern->SetUniformVariable("ufSOn", fSOn);
	Pattern->SetUniformVariable("uDt", Dt);
