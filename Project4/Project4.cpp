...
const char *WINDOWTITLE = { "Project4-Chao" };
...
GLuint	BoxList[5];				// object display list
GLuint	BladesList;// object display list
...
int     LookAt = 0;
int     Light0On,Light1On,Light2On=1;
float   Time,Change;
...
Display( )
{
    ...
    glScalef( (GLfloat)Scale, (GLfloat)Scale, (GLfloat)Scale );
        ...
        gluLookAt( -0.4, 1.8, -4.9,     -0.4, 3., -15.,     0., 1., 0. );
    ...
    width=1024;
    height=512;
    Texture = BmpToTexture( (char*)"/Users/chaozhang/Documents/CS550/Project4/worldtex.bmp", &width , &height );
    glBindTexture( GL_TEXTURE_2D, tex0 ); // make tex0 texture current // and set its parameters
    ...
    SetPointLight(GL_LIGHT0, 10*sin(2*M_PI*Time), 1., 1., 1., 1., 1.);
    SetSpotLight(GL_LIGHT1, 5., 5., 5., 0., 0., 0., 1., 0., 0.);
    SetPointLight(GL_LIGHT2, 10., 10., 10., 1., 1., 1.);
    ...
    {
        glPushMatrix();
        glTranslatef(10*sin(2*M_PI*Time), 1., 1.);
        glColor3f(1., 1., 1.);
    ...
    glLoadIdentity( );
    glColor3f( 1., 1., 1. );
    //DoRasterString( 5., 5., 0., (char *)"Watch out your feet !!!" );
...
InitLists( )
{
    ...
    glutSetWindow( MainWindow );
    BoxList[0] = glGenLists( 1 );
    glNewList( BoxList[0], GL_COMPILE );
